...
`),(e=>e.$tabsCount?"1px solid":"0")),xe=$().div(ue||(ue=be`
  ...
  border-bottom: 1px solid var(--border-color-default);
`)),fe=({minWidth:e,maxWidth:t,tabsCount:a,renderTabs:i,rightActions:n})=>{const s=(0,r.useRef)(null),l=(0,r.useRef)(null),[c,d]=(0,r.useState)(!1),[u,b]=(0,r.useState)(!1),[v,p]=(0,r.useState)(!1),[h,x]=(0,r.useState)(`${t}px`);return(0,r.useEffect)((()=>{let e;if(s.current&&l.current){const i=s.current.scrollWidth-s.current.clientWidth>0,n=Math.round(l.current.clientWidth/t);x(n<a?"100%":`${t}px`),d(i),i&&(e=setTimeout((()=>{var e;null==(e=s.current)||e.scrollTo(s.current.scrollWidth,0)}),1))}return()=>{e&&clearTimeout(e)}}),[a,t]),(0,r.useEffect)((()=>{let e=null;const t=s.current,a=()=>{const e=0===(null==t?void 0:t.scrollLeft),a=!!t&&t.scrollLeft===t.scrollWidth-t.clientWidth;b(e),p(a)},i=()=>{e&&clearTimeout(e),e=setTimeout(a,100)};return"onscrollend"in window?null==t||t.addEventListener("scrollend",a):null==t||t.addEventListener("scroll",i),()=>{"onscrollend"in window?null==t||t.removeEventListener("scrollend",a):null==t||t.removeEventListener("scroll",i),e&&clearTimeout(e)}}),[c]),(0,o.jsxs)(ve,{ref:l,children:[c&&(0,o.jsx)(xe,{children:(0,o.jsx)(U.Z,{type:"tertiary",icon:(0,o.jsx)(se.Z,{}),onClick:()=>{var t;null==(t=s.current)||t.scrollBy({left:2*-e,behavior:"smooth"})},isDisabled:u})}),(0,o.jsx)(pe,{ref:s,children:i(h,c)}),(0,o.jsxs)(he,{$tabsCount:a,children:[c&&(0,o.jsx)(U.Z,{type:"tertiary",icon:(0,o.jsx)(le.Z,{}),onClick:()=>{var t;null==(t=s.current)||t.scrollBy({left:2*e,behavior:"smooth"})},isDisabled:v}),n]})]})};var me=a(23180);let ge,ye,Te,Ce,we,je,ke,Ze,Le,Ne,De,Ee=e=>e;const Se=$().li(ge||(ge=Ee`
  position: relative;
  padding: 0;
  margin: 0;
  list-style: none;
