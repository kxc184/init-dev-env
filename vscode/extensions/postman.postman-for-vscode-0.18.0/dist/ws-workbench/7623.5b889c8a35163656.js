...
`),(({isFocused:e})=>e&&"\n        border: var(--border-width-default) var(--border-style-solid) var(--border-color-default);\n        background: var(--background-color-primary);\n        height: var(--size-s);\n        padding-left: var(--spacing-xs);\n        margin-top: var(--spacing-xs);\n        margin-right: var(--spacing-s);\n    "));function ie(e){const{value:l,isEditable:n,onBlur:i,onChange:t,onFocus:o,type:s}=e,a=`${s} masked cell`;return(0,g.jsx)(ne,{isFocused:Boolean(n),onBlur:i,onClick:o,onFocus:o,children:(0,g.jsx)("input",{role:"cell","aria-label":a,value:l||"",spellCheck:!1,type:"password",onChange:e=>{t(e.currentTarget.value)}},"text")})}var te=n(16913),oe=n(81397),se=n(72006);const ae=["hidden","value","isEditable","currentWidth","readOnly","shouldFocusOnMount","onBlur","onChange","onFocus","actions","editorType","maskState","enableVariableSuggestions","placeholder","isDuplicated"];let re;const de=s()(te.Z)(re||(re=(e=>e)`
  position: absolute;
  align-self: center;
  right: var(--spacing-s);
  z-index: 10;
...
`),(({isVisible:e})=>e?"1":"0")),sl=({isHidden:e=!1,children:l,isVisible:n})=>e||!l?null:(0,g.jsx)(ol,{isVisible:n,children:l});var al=n(78217);const rl=["warning"],dl=["prevValue","prevCurrentWidth"],cl=["nextValue","nextCurrentWidth"];let ul,hl,pl,bl,vl=e=>e;const gl=s().div(ul||(ul=vl`
  display: flex;
  flex-direction: row;
  position: relative;
  flex: 0;
...
//# sourceMappingURL=7623.5b889c8a35163656.js.map